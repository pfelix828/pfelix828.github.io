...
[View on GitHub](https://github.com/pfelix828/enrich-eval){.btn .btn-outline-primary}
...
Moving from v1 to v2 improved every headline number — merchant accuracy jumped from 54% to 87%,
category accuracy from 62% to 92%. But the averages hide the interesting parts.
...
…plus a specific recommendation for each: *add a tie-break rule to the rulebook*, *stop guessing the
